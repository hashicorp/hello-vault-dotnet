...
namespace WebApi
{
    ...
    {    
        ...
        {
            Secret<SecretData> secrets = _vaultClient.V1.Secrets.KeyValue.V2.ReadSecretAsync(path: "/kv-v2/data/api-key").Result;
            string apiKey = secrets.Data.Data["key"].ToString();
